package com.auth.authservicekeycloak.config;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, OidcClientInitiatedLogoutSuccessHandler oidcLogoutSuccessHandler) throws Exception {
        return http.authorizeHttpRequests(authorise ->
                ...
                .oauth2ResourceServer(oauth2 -> oauth2.jwt(withDefaults())) // Добавляем этот метод
                .logout(logout ->
    ...
    public JwtDecoder jwtDecoder() {
        return JwtDecoders.fromIssuerLocation("http://localhost:8080/auth/realms/myrealm");
    }
}
